    ...
    $.fn.characterCountdown = function (options) {
        ...
        var getRemainingCharacters = function () {
            ...
            if (remainingCharacters > 0) {
                ...
                el.siblings(plugin.settings.countdownTarget).text(plugin.settings.defaultText + remainingCharacters);

            } else {

                //set remaining characters to 0 and color them red
                el.siblings(plugin.settings.countdownTarget).text(plugin.settings.defaultText + 0).addClass('max');
