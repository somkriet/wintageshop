...
(function () {
     ...
     */
        ...
        drawControls: function (ctx) {
            ...
            rotate.src = 'assets/tool/rotate.jpg';

            var topleft = new Image();
            topleft.src = 'assets/tool/rotate_tl.png';

            var topright = new Image();
            topright.src = 'assets/tool/rotate_tr.png';

            var bottomleft = new Image();
            bottomleft.src = 'assets/tool/rotate_bl.png';

            var bottomright = new Image();
            bottomright.src = 'assets/tool/rotate_br.png';
        ...
        top - scaleOffset);*/
            ...
            ctx.drawImage(topleft, left - scaleOffset, top - scaleOffset, size, size);
        ...
        top - scaleOffset);*/
            ...
            ctx.drawImage(topright, left + width - scaleOffset, top - scaleOffset, size, size);
            // bottom-left
            /*this._drawControl('bl', ctx, methodName,
        left - scaleOffset,
        top + height - scaleOffset);*/
            ctx.drawImage(bottomleft, left - scaleOffset, top + height - scaleOffset, size, size);

            // bottom-right
            /* this._drawControl('br', ctx, methodName,
        left + width - scaleOffset,
        top + height - scaleOffset);*/
            ctx.drawImage(bottomright, left + width - scaleOffset, top + height - scaleOffset, size, size);
          ...
          top - this.rotatingPointOffset - scaleOffset);*/
                ctx.drawImage(rotate, left + width / 2 - scaleOffset, top - this.rotatingPointOffset - scaleOffset, size, size);
                //ctx.drawImage(left + width/2 - scaleOffset,top - this.rotatingPointOffset - scaleOffset, size, size);
            }
