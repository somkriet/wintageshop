...
POLO.colorPalleteslide = function () {
    $('.ui-toolbox .colorcontent > ul').bxSlider({
        minSlides: 6,
        maxSlides: 6,
        slideWidth: 200,
        slideMargin: 2,
...
POLO.expandItem = function (id, index) {
    ...
    $(id).prepend('<a onClick="POLO.backItem();" class="btn pinkbtn backapplication default_backbtn" style="display:block;"><i class="glyphicon glyphicon-arrow-left"></i> Back To All ' + name + '</a>');
    $(id + " .default_content").append('<div class="col-md-3 imagethumb">' +
